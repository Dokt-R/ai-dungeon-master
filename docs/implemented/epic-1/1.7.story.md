...
- Backend API and [`campaign_manager.py`](packages/backend/components/campaign_manager.py) now use [`server_manager.py`](packages/backend/components/server_manager.py) and SQLite for all campaign state.
...
- packages/backend/components/server_manager.py
