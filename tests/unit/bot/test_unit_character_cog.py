...
async def test_character_remove_command(mock_interaction, mock_character_cog):
    ...
    # Replace API client with mock
    cog.api_client = MockApiClient()
    cog.api_client.set_response_override('remove_character', {"message": "Character removed successfully"})
...
@pytest.mark.asyncio
async def test_character_add_command_backend_error(mock_interaction, mock_character_cog):
    cog = mock_character_cog
    # Replace API client with mock
    cog.api_client = MockApiClient()
    error = ErrorCode.DUPLICATE_CHARACTER
    cog.api_client.set_exception_override('add_character', ValidationError(error, details={"name": "Hero"}))
...
@pytest.mark.asyncio
async def test_character_remove_command_backend_error(mock_interaction, mock_character_cog):
    cog = mock_character_cog
    # Replace API client with mock
    cog.api_client = MockApiClient()
    ...
    cog.api_client.set_exception_override('remove_character', NotFoundError(error, details={"message": "Character not found"}))
