...
def get_combat_subgraph():
    ...
    workflow.add_node("end_combat", lambda state: {"combat_over": True}) # Simple node to mark the end
    ...
    workflow.add_edge("resolve_combat_action", "death_save") # Add death save after action resolution
    workflow.add_edge("death_save", "narrate_combat_event") # Narrate after action and death saves
